...
__C.YOLO.CLASSES              = "./data/classes/mare.names"
...
__C.TRAIN.ANNOT_PATH          = "./data/mare_hand_annotated/mare_annotations.txt"
...
__C.TEST.ANNOT_PATH           = "./data/mare_hand_annotated/mare_annotations.txt"
